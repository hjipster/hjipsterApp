package io.github.hjipster.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("hjipsterApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("hjipsterApp");
        ...
        config.getMapConfigs().put("io.github.hjipster.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
